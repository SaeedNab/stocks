      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview active">
          <a href="#">
            ...
            <span style="font-family: iran">کاربران</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
...
@if(\Illuminate\Support\Facades\Auth::guard('admin')->user()->role == 0)
        <li class="treeview">
          <a href="#">
            ...
            <span style="font-family: iran">مدیران</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('admin.admins.admin_list')}}"><i class="mdi mdi-toggle-switch-off"></i>لیست مدیران</a></li>
            <li><a href="{{route('admin.admins.create_admin')}}"><i class="mdi mdi-toggle-switch-off"></i>ایجاد مدیر  </a></li>
...
<script>
    jQuery(document).ready(function(){
        ...
        jQuery('.decline_confirmation').click(function(e){
            let td = $(this).parents('td');
            console.log(td);
            $(td).find('.decline_confirmation').hide();
            $(td).find('.accept_confirmation').hide();
            $(td).find('.sk-chase').show();
            e.preventDefault();
            $.ajaxSetup({
                headers: {
            ...
            jQuery.ajax({
                url: "{{route('admin.users.decline_confirm') }}",
                method: 'post',
                data: {
                    id: $(this).data('id')
    ...
    jQuery(document).ready(function(){
        ...
        jQuery('.accept_confirmation').click(function(e){
            let td = $(this).parents('td');
            console.log(td);
            $(td).find('.decline_confirmation').hide();
            $(td).find('.accept_confirmation').hide();
            ...
            jQuery.ajax({
                url: "{{route('admin.users.accept_confirm') }}",
                method: 'post',
                data: {
                    id: $(this).data('id')
