                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu animated flipInY">
                            ...
                            <li class="user-body">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('user.auth.logout')}}"><i class="ion-log-out"></i> خروج</a>
                                <div class="dropdown-divider"></div>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span style="font-family: iran">تنظیمات</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="pages/layout_boxed.html"><i class="mdi mdi-toggle-switch-off"></i>تغییر پسورد</a></li>
                        <li><a href="pages/layout_fixed.html"><i class="mdi mdi-toggle-switch-off"></i>ویرایش پروفایل</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/page_layout_inner_left_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>گردش حساب</a></li>
                        <li><a href="pages/page_layout_inner_right_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>گزارش واریز وجه  </a></li>
                        <li><a href="pages/page_layout_inner_fixed_left_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>گزارش دریافت وجه  </a></li>
                        <li><a href="pages/page_layout_inner_fixed_right_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>واریز وجه  </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/page_layout_inner_left_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>واریز وجه </a></li>
