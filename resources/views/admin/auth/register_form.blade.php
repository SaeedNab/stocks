                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="p-40 bg-white content-bottom">
                            @if(count($errors)>0)
                                ...
                                @endforeach
                            @endif
                            <form action="{{route('admin.auth.register')}}" method="post" class="form-element">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15" placeholder="شماره ملی" name="nation_code">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15" placeholder="شماره تماس" name="phone_number">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0">قبلا ثبت نام کرده اید؟<a href="auth_login.html" class="text-danger ml-5"> ورود</a></p>
                            </div>
                        </div>
                    </div>
                </div>
