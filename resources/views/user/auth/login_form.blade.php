                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="p-40 bg-white content-bottom h-p100">
                            ...
                            @endif
                                ...
                                @endif
                            <form action="{{route('user.auth.login')}}" method="post" class="form-element">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="fog-pwd text-right">
                                            <a href="{{route('user.auth.forget_password')}}"><i class="ion ion-locked"></i> فراموشی کلمه ی عبور</a><br>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0">حساب کاربری ندارید؟ <a href="{{route('user.auth.register_form')}}" class="text-info ml-5">ثبت نام</a></p>
                            </div>
                        </div>
                    </div>
                </div>
